...
import bagPlus from './icons/bag-plus.png';
...
const tshirtImg = document.querySelector('.tshirtImg');
tshirtImg.src = t1;

const tshirtImg2 = document.querySelector('.tshirtImg2');
tshirtImg2.src = t2;

const tshirtImg3 = document.querySelector('.tshirtImg3');
tshirtImg3.src = t3;

const tshirtImg4 = document.querySelector('.tshirtImg4');
tshirtImg4.src = t4;
            ...
            <div class="item">
                <div class="item-container">
                    ...
                    <div class="add-to-cart" onclick="addToCart(${product.id})">
                        <img src=${bagPlus} alt="add to cart">
                    </div>
                </div>
            </div>
        `;
